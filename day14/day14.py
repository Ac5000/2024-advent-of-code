...
class Grid:
    ...
    def update_map(self) -> None:
        ...
        self._make_or_clear_map()
        for robot in self.robots:
            if self.map_positions[robot.current_y][robot.current_x] == ".":
                self.map_positions[robot.current_y][robot.current_x] = str(1)
            else:
                self.map_positions[robot.current_y][robot.current_x] = str(
                    1
                    + int(self.map_positions[robot.current_y][robot.current_x])
                )
